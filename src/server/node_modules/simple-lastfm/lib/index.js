...
Lastfm.prototype.doScrobble = function(options) {
	...
	if((options.session_key == undefined || options.session_key == '') && typeof options.callback == 'function') {
...
//	session.scrobbled = true;
	...
	if(this.debug)
		console.log("Using session key: " + session_key + "\n\n");
	var authToken = md5(this.username + md5(this.password));
	var sig = 'api_key' + this.api_key +
						'artist' + options.artist +
						'method' + options.method +
						'sk' + session_key +
						'timestamp' + options.timestamp +
						'track' + options.track + this.api_secret;
  // console.log("sig = " + sig);
	var api_sig = md5(sig);
